    ...
    {/* search menu  */}
      ...
      <div className='z-20 mx-6 my-1 w-1/5 absolute h-35 flex gap-10 p-2 bg-ztranparent'>
            ...
            <div className='w-full flex flex-row gap-[1px] h-[35px] justify-center items-center bg-zlightgray rounded-md text-white'>
                  <div className='w-1/5 h-full rounded-l-md bg-zmapmenu flex justify-center items-center pt-[0.5rem] pb-[0.5rem]'><Layer className='fill-white'/></div>
                  <div className='w-1/5 h-full bg-zmapmenu flex justify-center items-center pt-[0.5rem] pb-[0.5rem]'><Opacity className='fill-white'/></div>
                  <div className='w-1/5 h-full bg-zmapmenu flex justify-center items-center pt-[0.5rem] pb-[0.5rem]'><Screenshot className='fill-white'/></div>
                  <div className='w-1/5 h-full bg-zmapmenu flex justify-center items-center pt-[0.5rem] pb-[0.5rem]'><Print className='fill-white'/></div>
                  <div className='w-1/5 h-full bg-zmapmenu rounded-r-md flex justify-center items-center pt-[0.5rem] pb-[0.5rem]'><Zoingboard className="fill-white stroke-1 stroke-gray"/></div>
            </div>
      </div>
         <MapsGoogle/>
         <Legend/>
